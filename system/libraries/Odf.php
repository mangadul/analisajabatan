...
require 'odf/library/zip/PclZipProxy.php';
require 'odf/library/zip/PhpZipProxy.php';
require 'odf/library/Segment.php';
...
class CI_Odf
{
    ...
    public function cfile($filename, $config = array())
    {
        if (! is_array($config)) {
...
IMG;
    ...
    public function setSegment($segment)
    {
        ...
        if (preg_match($reg, trim(html_entity_decode($this->contentXml)), $m) == 0) {
